...
dove gli attributi sottolineati indicano la chiave primaria, gli attributi segnati con l'asterisco attributi per cui è ammesso il valore nullo, contrariamente agli attributi non contrassegnati mediante quest'ultimo.
...
Si noti infine l'aggiunta della clausola ON DELETE CASCADE, la quale predispone l'eliminazione automatica e coerente di tutti i messaggi associati a una determinata sessione nel caso in cui quest'ultima dovesse essere eliminata.   
